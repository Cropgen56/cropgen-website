    ...
    imagesToLoad.forEach((src) => {
      ...
      img.onload = () => {
        ...
        if (loaded === imagesToLoad.length) {
          setTimeout(() => setIsLoading(false), 200); // small delay for smooth fade
        }
      };
    });
  }, []);
      ...
      >
        ...
        <div className="flex flex-col gap-4 relative">
          ...
          <ul className="flex flex-col gap-2 text-gray-600 ml-2 md:ml-4 text-sm md:text-lg">
            <li>
              <strong className="text-gray-900">Remote Sensing Technology:</strong>{" "}
            ...
            <li>
              <strong className="text-gray-900">Crop Monitoring Services:</strong>{" "}
