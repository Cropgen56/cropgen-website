...
const HeroSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex flex-col md:flex-row justify-between bg-white pb-7 md:pb-10 min-h-screen"
    >
      {/* Left */}
      <article
        className={`md:w-1/2 text-center lg:text-left space-y-3 pt-8 md:px-8 ${isLaptop ? "md:pt-20" : ""}`}
      >
        <h1
          ref={h1Ref}
          className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-relaxed"
        >
          AI-Powered Geospatial <br />
          Intelligence for Global Precision <br /> Agriculture
        </h1>
        <br />

        <p ref={pRef} className="text-gray-700 text-sm md:text-base ">
          The power of AI and remote sensing to drive <br />
          precision agriculture. Designed for farmers,
          <br /> agronomists, agri-businesses, and researchers, <br /> CropGen
          delivers real-time, data-driven insights for smarter decision-making
      ...
      <div className="relative md:w-1/2 flex justify-start items-center mt-8 md:mt-0 px-6 md:px-0">
        <div
          ref={bgRef}
          className="absolute inset-0 bg-[url('/assets/image/home/line.png')] bg-cover bg-center bg-no-repeat opacity-100 h-[100%] w-[100%] z-[1]"
        />
        ...
        <div className="relative w-full max-w-md md:max-w-lg lg:max-w-xl z-10 flex justify-start">
          ...
          >
            <Image
              src="/assets/image/home/doughnut.webp"
          ...
          >
            <Image
              src="/assets/image/home/soil-chart.webp"
