...
export default function ChatWindow({ onClose }) {
    ...
    return (
        <div className="relative">
            ...
            <div className="relative w-[300px] h-[450px] sm:w-[400px] sm:h-[500px] rounded-2xl p-[2.5px] bg-gradient-to-r from-[#9BE2BE] via-[#ABE597] to-[#D3EC70] bg-[length:300%_300%] animate-gradient">
