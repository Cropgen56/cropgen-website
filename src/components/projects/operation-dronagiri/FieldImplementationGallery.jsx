  ...
  return (
    <div className="w-full max-w-7xl mx-auto mt-10 px-4">
      ...
      <div className="flex items-center justify-center flex-wrap md:flex-nowrap gap-3">
        ...
        <button
          onClick={handlePrev}
          className="p-2 rounded-full bg-[#E4FFF1] hover:bg-[#28C878] transition-all duration-300 outline-none"
        >
        ...
        <motion.div
          ...
          className="relative cursor-pointer aspect-[16/9] w-[calc(48rem-4rem)] max-w-[calc(100%-4rem)] rounded-xl overflow-hidden shadow-md ring-1 ring-gray-300"
        >
          <Image
        ...
        <button
          onClick={handleNext}
          className="p-2 rounded-full bg-[#2AB673] text-white hover:bg-[#24965a] transition-all duration-300 outline-none"
        >
