...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-md px-6 py-3 fixed top-0 right-0 left-0 z-40">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        {/* ✅ Logo with Custom Color */}
        <div className="text-[#075A53] text-xl font-semibold flex items-center justify-center gap-2 ">
          <Image
