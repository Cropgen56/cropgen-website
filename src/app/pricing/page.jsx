            ...
            <div className="min-h-screen bg-white px-6 py-12 flex flex-col items-center ">
                ...
                <div className="flex flex-col items-center gap-4 mb-12">
                    ...
                    <div className="flex items-center gap-4">
                        <span
                            className={`font-bold text-[16px] cursor-pointer ${billing === "monthly" ? "text-[#2AB673]" : "text-gray-400"}`}
                        ...
                        >
                            <div
                                className={`absolute top-1 w-8 h-8 rounded-full transition-all ${billing === "monthly" ? "left-1 bg-[#2AB673]" : "left-11 bg-[#2AB673]"}`}
                            />
                        </div>
                        <span
                            className={`font-bold text-[16px] cursor-pointer ${billing === "yearly" ? "text-[#2AB673]" : "text-gray-400"}`}
                ...
                <div className="px-3 py-4 bg-[#EEFFF9]">
                    ...
                    <div className="text-center text-black text-sm font-bold mt-12">
                        Prices are exclusive of VAT, GST, or other applicable taxes in your region. <br />
                        If you require an invoice to process your CropGen subscription, please contact our support team.
                    </div>
                </div>
            </div>
